package com.example.gestiondunebandedongletsavecfragments.ui.main;
...
import com.example.gestiondunebandedongletsavecfragments.NatureFragment;
import com.example.gestiondunebandedongletsavecfragments.R;
    ...
    public CharSequence getPageTitle(int position) {
        ...
        switch (position) {
            case 0:
                ...
                icone = mContext.getResources().getDrawable(R.drawable.mineraux);
                break;
            case 1:
                titre = mContext.getString(R.string.titre_section1).toUpperCase(l);
                icone = mContext.getResources().getDrawable(R.drawable.vegetaux);
                break;
            case 2:
                titre = mContext.getString(R.string.titre_section2).toUpperCase(l);
                icone = mContext.getResources().getDrawable(R.drawable.animaux);
                break;
        }
